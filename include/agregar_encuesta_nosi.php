...
<?php
	...
	$campos_requeridos = array('sexo_id', 'edad_id','educacion_id','red2','red3','red4','red5','red6','red7','red8','pre_si1','pre_si2','pre_si3','pre_si4','pre_si5','pre_si6','pre_si7','pre_si8','pre_si9','pre_si10','pre_si11','pre_si12','pre_si13','pre_si14','pre_si15','pre_si16','pre_si17','pre_si18','pre_si19','pre_si20','pre_si21','pre_si22','pre1','pre2','pre3','pre4','pre5','pre6','pre7','pre8','pre9','pre10','pre11','pre12','pre13','pre14','pre15');
...
<?php
   	...
   	$query = "INSERT INTO encuesta_nosi
	(sexo, edad, educacion, tiempo_inicio_uso, frecuencia_uso, red_social, tiempo_uso, dispositivo, uso_trabajo, porque_no, uso1, uso2, uso3, uso4, uso5, uso6, uso7,uso8, uso9, uso10, uso11, uso12, uso13, uso14, uso15, uso16, uso17, uso18, uso19, uso20, uso21, uso22,total_satisfaccion) 
	VALUES 	('{$sexo_id}','{$edad_id}','{$educacion_id}','{$red2}','{$red3}','{$red4}','{$red5}','{$red6}','{$red7}','{$red8}','{$pre_si1}','{$pre_si2}','{$pre_si3}','{$pre_si4}','{$pre_si5}','{$pre_si6}','{$pre_si7}','{$pre_si8}','{$pre_si9}','{$pre_si10}','{$pre_si11}','{$pre_si12}','{$pre_si13}','{$pre_si14}','{$pre_si15}','{$pre_si16}','{$pre_si17}','{$pre_si18}','{$pre_si19}','{$pre_si20}','{$pre_si21}','{$pre_si22}',{$total})";
